...
namespace MoodWeather.Controls
{
    /// <summary>
    ...
    public class CustomDataForm : DataForm
    {
        ...
        /// <summary>
        ///     Extends <see cref="DataForm.OnAutoGeneratingField" /> by replacing <see cref="TextBox" />es with
        ///     <see
        ///         cref="PasswordBox" />
        ///     es
        ///     whenever applicable
        ...
        protected override void OnAutoGeneratingField(DataFormAutoGeneratingFieldEventArgs e)
        {
            ...
            PropertyInfo propertyInfo = CurrentItem.GetType().GetProperty(e.PropertyName);

            // Do the password field replacement if that is the case
            if (e.Field.Content is TextBox && IsPasswordProperty(propertyInfo))
            {
