...
namespace MoodWeather
{
    ...
    public class TargetNullValueConverter : IValueConverter
    {
        ...
        /// <returns>
        ///     If the <paramref name="value" />is <c>null</c> or empty, this method returns <c>null</c> otherwise it returns the
        ///     <paramref
        ///         name="value" />
        ///     .
        /// </returns>
        ...
        /// <param name="culture">The culture for the conversion (ignored).</param>
        /// <returns>
        ///     If <paramref name="value" /> is <c>null</c>, it returns <see cref="String.Empty" /> otherwise
        ///     <paramref
        ///         name="value" />
        ///     .
        /// </returns>
