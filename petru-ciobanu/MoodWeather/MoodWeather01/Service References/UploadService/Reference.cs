...
// 
namespace MoodWeather.UploadService {
    ...
    public interface IUploadService {
        ...
        [System.ServiceModel.OperationContractAttribute(AsyncPattern=true, Action="http://tempuri.org/IUploadService/FileUpload", ReplyAction="http://tempuri.org/IUploadService/FileUploadResponse")]
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IUploadServiceChannel : MoodWeather.UploadService.IUploadService, System.ServiceModel.IClientChannel {
    }
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class UploadServiceClient : System.ServiceModel.ClientBase<MoodWeather.UploadService.IUploadService>, MoodWeather.UploadService.IUploadService {
        ...
        System.IAsyncResult MoodWeather.UploadService.IUploadService.BeginFileUpload(byte[] fileStream, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginFileUpload(fileStream, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        string MoodWeather.UploadService.IUploadService.EndFileUpload(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginFileUpload(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            return ((MoodWeather.UploadService.IUploadService)(this)).BeginFileUpload(fileStream, callback, asyncState);
        }
        
        private object[] OnEndFileUpload(System.IAsyncResult result) {
            string retVal = ((MoodWeather.UploadService.IUploadService)(this)).EndFileUpload(result);
            return new object[] {
                    retVal};
        }
        ...
        protected override MoodWeather.UploadService.IUploadService CreateChannel() {
            return new UploadServiceClientChannel(this);
        }
        
        private class UploadServiceClientChannel : ChannelBase<MoodWeather.UploadService.IUploadService>, MoodWeather.UploadService.IUploadService {
            
            public UploadServiceClientChannel(System.ServiceModel.ClientBase<MoodWeather.UploadService.IUploadService> client) : 
                    base(client) {
            }
