...
public class RaduApplication extends Application {
	...
	public void start(final Stage stage) throws Exception {
		...
		Address localAddress = addressFactory.createAddress(addressFactory.createSipURI("radu", "leon.telecast.ro"));
		localAddress.setDisplayName("Radu Obreja");		
		config.setLocalAddress(localAddress);		
		config.setLocalPassword("radu");
		config.setRemoteUser("andrei");		
